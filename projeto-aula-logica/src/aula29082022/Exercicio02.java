...
public class Exercicio02 {
    ...
    //três strings (nome próprio, nome do meio e nome da família).

    // Escreva nessa classe o método rubrica que retorna somente as iniciais do nome completo
    // em caracteres minúsculos, e
