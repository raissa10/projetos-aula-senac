package springwebpostgresql.controller;
...
import springwebpostgresql.repository.TutorialRepository;

// Configura o cors do front-end que esta em outra porta
...
public class TutorialController {
  ...
  public String getPaginaInicial() {
    return "[{\"status\": \"true\", \"mensagem\":\"Bem vindo a API Demo Conexao PostgreSQL\"}]";
  }

    @GetMapping("/tutoriais")
  public List<Tutorial> getAllTutoriais() {
...
//
      ...
      Tutorial tutorialError = new Tutorial("Erro ao listar tutoriais", "Erro:" + e.getMessage(), published);

      tutorials.add(tutorialError);
