...
/**
 * Standard input. This class provides methods for reading strings and numbers
 * from standard input. See the technical information in the documentation of
...
public final class StdIn {
     ...
     */
    /**
     * Is the input empty (except possibly for whitespace)? (A whitespace is a
     * space, or a tab, or a newline, etc.) Use this to know whether the next
     * call to {@link #readString()}, {@link #readDouble()}, etc will succeed.
     */
     ...
     * to {@link #readLine()} will succeed. Functionally equivalent to
     * {@link #hasNextChar()}.
     */
    ...
    /**
     * Is the input empty (not even whitespace)? Use this to know whether the
     * next call to {@link #readChar()} will succeed. Functionally equivalent to
     * {@link #hasNextLine()}.
     */
    ...
    /**
     * Read and return the next string. Uses whitespaces (space, tab, newline,
     * etc.) as delimiters.
     */
    ...
    /**
     * DEPRECATED: For more consistency, use readAllInts(). Reads all ints from
     * stdin.
     */
