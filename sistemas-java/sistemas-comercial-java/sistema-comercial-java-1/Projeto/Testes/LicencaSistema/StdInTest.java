...
public class StdInTest {
    ...
    /**
     * In the two methods below, each Object[] of "steps" is a length-2 array:
     * the first is a String holding a method name, the second is the expected
     * return value when that method is called in sequence.
     */
