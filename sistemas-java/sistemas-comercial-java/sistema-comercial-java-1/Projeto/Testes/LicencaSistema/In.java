 ...
 * <p>
 * The underlying mechanism is that of <tt>java.util.Scanner</tt>, which breaks
 * input into tokens delimited by whithespace. Like {@link Scanner}, reading a
 * token also consumes preceding Java whitespace, reading a full line consumes
...
public final class In {
     ...
     * whether the next call to {@link #readString()},
    ...
    /**
     * Read all strings (separated by whitespace) until the end of input is
     * reached, and return them as an array of strings.
     */
