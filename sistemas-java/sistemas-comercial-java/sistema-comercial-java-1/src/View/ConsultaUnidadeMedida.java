 ...
 * @author Gelvazio
 */
public class ConsultaUnidadeMedida extends TelaPadraoGlobal {
    ...
    private void ListaTodasUnidadesMedidas() {
        ...
        ArrayList<UnidadeMedidaProduto> unidadesmedidas = unidademedidadb.getTodos();
        for (UnidadeMedidaProduto auxUnidadeMedida : unidadesmedidas) {
