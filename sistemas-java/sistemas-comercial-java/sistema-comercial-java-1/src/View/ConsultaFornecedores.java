 ...
 * @author Gelvazio
 */
public class ConsultaFornecedores extends TelaPadraoGlobal {
    ...
    private void ListaTodosFornecedores() {
        ...
        ArrayList<Pessoas> pessoas = pessoadb.getTodosFornecedores();
    ...
    public void ListaPessoasCompleto() {
        ...
        ArrayList<Pessoas> pessoas = SQLConsultagetTodos_Completo();
        for (Pessoas auxPessoa : pessoas) {
            modelo.addRow(new Object[]{
                auxPessoa.getCd_pessoa(),
                auxPessoa.getNm_pessoa(),
