...
public class Login extends JFrame {
    ...
    private static final String SQL_BUSCA_USUARIO = "SELECT * FROM usuario WHERE ds_usuario = ?";
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnSair, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 140, 100, -1));
    ...
    private boolean validaSenhaUsuario() {
        ...
        if (usuariodb.getLogin(auxLoginTela)) {
            try {
                ...
                while (rs.next()) {
                    String auxLogin = rs.getString("ds_usuario");
