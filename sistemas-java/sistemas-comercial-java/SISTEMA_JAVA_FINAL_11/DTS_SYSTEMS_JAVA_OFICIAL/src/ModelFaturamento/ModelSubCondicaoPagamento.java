 ...
 */
public class ModelSubCondicaoPagamento {
    ...
    public ModelSubCondicaoPagamento(int cd_condicao, int cd_parcela, int nr_dias_parcela, int cd_cobranca, int cd_usuario) {
