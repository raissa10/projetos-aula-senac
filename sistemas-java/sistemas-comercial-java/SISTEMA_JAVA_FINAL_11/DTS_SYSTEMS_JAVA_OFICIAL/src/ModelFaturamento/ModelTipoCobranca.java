 ...
 */
public class ModelTipoCobranca {
    ...
    public ModelTipoCobranca(int cd_cobranca, String ds_cobranca, int fg_imediato, int fg_cheque, int fg_boleto, int fg_crediario, int fg_cartao, int fg_quita_quando_gera, int fg_ativo, int cd_filial, int cd_usuario) {
