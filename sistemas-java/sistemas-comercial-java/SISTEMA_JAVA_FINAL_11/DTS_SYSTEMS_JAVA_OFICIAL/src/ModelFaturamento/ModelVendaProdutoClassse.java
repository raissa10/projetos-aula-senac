 ...
 * @author Gelvazio /
 */
public class ModelVendaProdutoClassse {
    ...
    public ModelVendaProdutoClassse(int quantidade, double preco, int produto, int cd_filial, int cd_movimento, int cd_seq_ite_pro, int cd_usuario, double vl_custo) {
