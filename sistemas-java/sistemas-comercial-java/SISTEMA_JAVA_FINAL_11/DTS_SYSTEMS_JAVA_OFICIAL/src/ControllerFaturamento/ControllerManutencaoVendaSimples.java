...
import ModelFaturamento.ModelVendaClasse;
 ...
 */
public class ControllerManutencaoVendaSimples extends ControllerManutencaoPadrao {
    ...
    public boolean gravarVenda(ModelVendaClasse venda) {
        ...
        try {
            ...
            pstmt.setInt(1, venda.getCodigoFilial());
    ...
    public boolean alterarVenda(ModelVendaClasse venda) {
        ...
        try {
            ...
            pstmt.setInt(8, venda.getCodigoFilial());
