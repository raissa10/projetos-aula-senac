...
import ViewConsultasCadastro.ViewConsultaEstado;
 ...
 * @author Gelvazio
 */
public class ViewManutencaoEstado extends ViewManutencaoPadrao {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 350, 130));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 10, 142, -1));
    ...
    private void btnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultaActionPerformed
        ViewConsultaEstado form = new ViewConsultaEstado(edtSigla);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new ViewManutencaoEstado().setVisible(true);
            }
        });
    }
