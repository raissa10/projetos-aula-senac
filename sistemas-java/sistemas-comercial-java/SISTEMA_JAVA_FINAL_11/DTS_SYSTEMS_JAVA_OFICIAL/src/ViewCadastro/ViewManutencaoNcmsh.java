...
import ControllerCadastro.ControllerManutencaoNcmsh;
import static Estrutura.Mensagem.mensagemErro;
import Estrutura.ViewManutencaoPadrao;
import ModelCadastro.ModelNcmsh;
import ViewConsultasCadastro.ViewConsultaNcmsh;
 ...
 */
public class ViewManutencaoNcmsh extends ViewManutencaoPadrao {

    ControllerManutencaoNcmsh ncmshdb = new ControllerManutencaoNcmsh();

    public ViewManutencaoNcmsh() {
        initComponents();
    ...
    private void gravarAlterar() {
        ...
        if (auxcd_ncmsh.equals("")) {
            ...
            ModelNcmsh ncmsh = new ModelNcmsh(
                    cd_codigo,
                    auxcd_ncmsh,
                    ds_titulo_1,
                    ds_titulo_2,
    ...
    private void ValidaCodigoNaoNulo() {
        ...
        if (ncmshdb.getCodigoNCMSH(cd_codigo)) {
            ...
            ArrayList<ModelNcmsh> ncmshs = ncmshdb.listaNCMSH(cd_codigo);
            for (ModelNcmsh auxNCMSH : ncmshs) {
    ...
    private void btnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultaActionPerformed
        ...
        ViewConsultaNcmsh form = new ViewConsultaNcmsh(edtCodigo);
    ...
    private void edtCodigoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_edtCodigoKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (auxTexto.equals("")) {
                ...
                String auxCodigoGenerator = "" + ncmshdb.validaCodigoGenerator("CD_NCMSH");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewManutencaoNcmsh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new ViewManutencaoNcmsh().setVisible(true);
            }
        });
    }
