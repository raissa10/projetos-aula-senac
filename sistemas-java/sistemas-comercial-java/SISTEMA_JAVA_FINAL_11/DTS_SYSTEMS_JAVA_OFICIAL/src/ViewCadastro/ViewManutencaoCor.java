 ...
 */
public class ViewManutencaoCor extends ViewManutencaoPadrao {
    ...
    private void validaCodigoNaoNulo() {
        if (cordb.getCor(Integer.parseInt(edtCodigo.getText()))) {
            habilitaCampos(true);
            ArrayList<ModelCor> cores = cordb.listaCores(Integer.parseInt(edtCodigo.getText()));
            for (ModelCor auxCor : cores) {
                edtDescricao.setText(auxCor.getDs_cor());
            }
            edtDescricao.requestFocus();
        } else {
            String auxCodigoGenerator = "" + cordb.validaCodigoGenerator("CD_COR");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewManutencaoCor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new ViewManutencaoCor().setVisible(true);
            }
        });
    }
