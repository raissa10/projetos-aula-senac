 ...
 * @author geo
 */
public class ViewManutencaoPais extends ViewManutencaoPadrao {

    ControllerManutencaoPais paisdb = new ControllerManutencaoPais();

    public ViewManutencaoPais() {
        initComponents();
    ...
    private void ValidaCodigoNaoNulo() {
        ...
        if (paisdb.getPais(cd_pais)) {
            HabilitaCampos(true);
            ArrayList<ModelPais> paises = paisdb.listaPaises(cd_pais);
    ...
    private void edtCodigoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_edtCodigoKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (auxTexto.equals("")) {
                ...
                String auxCodigoGenerator = "" + paisdb.validaCodigoGenerator("CD_PAIS");
    ...
    private void btnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultaActionPerformed
        ViewConsultaPais form = new ViewConsultaPais(edtCodigo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewManutencaoPais.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new ViewManutencaoPais().setVisible(true);
            }
        });
    }
