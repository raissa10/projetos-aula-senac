...
/**
 *
 * @author Gelvazio Camargo Tabela banco dados CREATE TABLE ModelNcmsh ( CD_CODIGO
...
public class ModelNcmsh {
    ...
    public ModelNcmsh(int cd_codigo, String cd_ncmsh, String ds_titulo_1, String ds_titulo_2, String ds_ncmsh, int vl_mva) {
