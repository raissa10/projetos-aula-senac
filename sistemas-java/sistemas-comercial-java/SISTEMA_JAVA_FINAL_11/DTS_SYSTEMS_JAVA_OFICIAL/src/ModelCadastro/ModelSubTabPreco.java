...
public class ModelSubTabPreco {
    ...
    public ModelSubTabPreco(long cd_ref, double vl_custo, double vl_venda, double vl_promocao, double vl_especial, double vl_custo_med, double tx_margem_lucro_venda, double tx_margem_lucro_promocao, double tx_margem_lucro_especial, int cd_usuario, int cd_filial) {
        this.cd_ref = cd_ref;
