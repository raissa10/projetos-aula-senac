 ...
 * @author Gelvazio
 */
public class ViewConsultaVendedores extends ViewManutencaoPadrao {
    ...
    private void ListaTodosFornecedores() {
        ...
        ArrayList<ModelPessoa> pessoas = pessoadb.getTodosVendedores();
    ...
    public ViewConsultaVendedores(JTextField campoCodigo) {
        initComponents();
