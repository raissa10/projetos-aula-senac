 ...
 * @author Gelvazio
 */
public class ViewConsultaTransportadora extends ViewManutencaoPadrao {
    ...
    private void ListaTodasTransportadoras() {
        ...
        ArrayList<ModelPessoa> pessoas = pessoadb.getTodasTransportadoras();
    ...
    public ViewConsultaTransportadora(JTextField campoCodigo) {
        initComponents();
        ListaTodasTransportadoras();
