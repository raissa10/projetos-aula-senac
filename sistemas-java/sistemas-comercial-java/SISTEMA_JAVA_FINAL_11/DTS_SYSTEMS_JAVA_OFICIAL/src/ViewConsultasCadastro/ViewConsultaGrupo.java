 ...
 * @author Gelvazio
 */
public class ViewConsultaGrupo extends ViewManutencaoPadrao {
    ...
    public void ListaTodosGrupos() {
        ...
        ArrayList<ModelGrupo> grupos = grupodb.getTodos();
        for (ModelGrupo auxGrupo : grupos) {
            modelo.addRow(new Object[]{
                auxGrupo.getCd_grupo(),
                auxGrupo.getDs_grupo()
            });
        }
        tbGrid.setModel(modelo);
    }

    public ViewConsultaGrupo(JTextField campoCodigo) {
        initComponents();
        ListaTodosGrupos();
