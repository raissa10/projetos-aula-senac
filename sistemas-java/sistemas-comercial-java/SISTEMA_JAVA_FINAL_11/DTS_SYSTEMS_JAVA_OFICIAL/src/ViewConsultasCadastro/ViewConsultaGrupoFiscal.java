 ...
 * @author Gelvazio
 */
public class ViewConsultaGrupoFiscal extends ViewConsultaPadrao {
    ...
    public void ListaTodosGruposFiscais() {
        ...
        ArrayList<ModelGrupoFiscal> gruposfiscais = grupofiscaldb.getTodos();
    ...
    public ViewConsultaGrupoFiscal(JTextField campoCodigo) {
        initComponents();
        ListaTodosGruposFiscais();
