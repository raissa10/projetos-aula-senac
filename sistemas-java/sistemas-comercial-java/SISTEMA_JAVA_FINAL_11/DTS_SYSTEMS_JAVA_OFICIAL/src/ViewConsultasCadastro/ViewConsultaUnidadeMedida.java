 ...
 * @author Gelvazio
 */
public class ViewConsultaUnidadeMedida extends ViewManutencaoPadrao {
    ...
    private void ListaTodasUnidadesMedidas() {
        ...
        ArrayList<ModelUnidadeMedida> unidadesmedidas = unidademedidadb.getTodos();
        for (ModelUnidadeMedida auxUnidadeMedida : unidadesmedidas) {
    ...
    public ViewConsultaUnidadeMedida(JTextField campoCodigo) {
        initComponents();
        ListaTodasUnidadesMedidas();
