 ...
 * @author Gelvazio
 */
public class ViewConsultaFornecedores extends ViewManutencaoPadrao {
    ...
    private void ListaTodosFornecedores() {
        ...
        ArrayList<ModelPessoa> pessoas = pessoadb.getTodosFornecedores();
    ...
    public void ListaPessoasCompleto() {
        ...
        ArrayList<ModelPessoa> pessoas = SQLConsultagetTodos_Completo();
        for (ModelPessoa auxPessoa : pessoas) {
            modelo.addRow(new Object[]{
                auxPessoa.getCd_pessoa(),
                auxPessoa.getNm_pessoa(),
    ...
    public ViewConsultaFornecedores(JTextField campoCodigo) {
        initComponents();
