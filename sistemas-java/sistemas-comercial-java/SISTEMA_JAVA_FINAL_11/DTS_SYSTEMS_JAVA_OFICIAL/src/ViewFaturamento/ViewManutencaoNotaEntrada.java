 ...
 * @author Gelvazio
 */
public class ViewManutencaoNotaEntrada extends ViewManutencaoPadrao {
    ...
    public ViewManutencaoNotaEntrada() {
        initComponents();
        //habilitaCampos(false);
        //edtCodigoMovimento.requestFocus();
        //Tela no centralizaFormulario
    ...
    /*
     ...
     ControllerManutencaoVendaSimples vendadb = new ControllerManutencaoVendaSimples();
     ...
     ControllerManutencaoVendaProduto venprodb = new ControllerManutencaoVendaProduto();
     ...
     ControllerManutencaoVendaProduto venprodb = new ControllerManutencaoVendaProduto();
     ModelVendaProdutoClassse venclasse = new ModelVendaProdutoClassse(
     aux_quantidade,
     aux_vl_preco,
     aux_cd_referencia,
     auxcd_filial,
    ...
    private void initComponents() {
        ...
        ViewCadastro = new javax.swing.JTabbedPane();
        ...
        ViewCadastro.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        ViewCadastro.addTab("Principal", AbaPrincipal);
        ...
        ViewCadastro.addTab("Itens", AbaFiscal);
        ...
        ViewCadastro.addTab("Parcelas", jPanel10);

        getContentPane().add(ViewCadastro, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 670, 630));
    ...
    private void btnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultaActionPerformed
        //ConsultaPedido form = new ViewConsultaPedido(edtCodigoMovimento);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewManutencaoNotaEntrada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewManutencaoNotaEntrada().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTabbedPane ViewCadastro;
