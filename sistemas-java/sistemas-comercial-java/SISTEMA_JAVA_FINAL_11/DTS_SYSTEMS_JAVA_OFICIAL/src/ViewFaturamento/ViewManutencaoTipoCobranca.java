 ...
 */
public class ViewManutencaoTipoCobranca extends ViewManutencaoPadrao {

    ControllerManutencaoTipoCobranca tipocobrancadb = new ControllerManutencaoTipoCobranca();

    public ViewManutencaoTipoCobranca() {
        initComponents();
    ...
    private void ValidaCodigoNaoNulo() {
        ...
        if (tipocobrancadb.getTipoCobranca(cd_cobranca)) {
            habilitaCampos(true);
            ArrayList<ModelTipoCobranca> tiposcobrancas = tipocobrancadb.listaTiposCobranca(cd_cobranca);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewManutencaoTipoCobranca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewManutencaoTipoCobranca().setVisible(true);
            }
        });
    }
