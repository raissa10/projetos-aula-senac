 ...
 * @author Gelvazio
 */
public class ViewManutencaoTipoNota extends ViewManutencaoPadrao {
...
//        edtHoraSaida.setEnabled(false);
    ...
    private void initComponents() {
        ...
        ViewCadastro.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tipos de Notas", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.ABOVE_TOP));
        ...
        ViewCadastro.addTab("Fiscal", AbaFiscal);

        getContentPane().add(ViewCadastro, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 0, 670, 580));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewManutencaoTipoNota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewManutencaoTipoNota().setVisible(true);
            }
        });
    }
